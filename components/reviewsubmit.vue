...
<v-dialog v-model="showModal" persistent max-width="568">
      ...
      <v-card style="width: 550px; justify-content: center; align-items: center; border-radius: 15px"  class="d-flex flex-column text-center pa-10">
        ...
        <h3 style="font-size: 32px; font-weight: 600; line-height: 40px; color: #2a2a2a">You have successfully submitted your business registeration</h3>
        <p class="mt-4" style="font-size: 16px; font-weight: 500; line-height: 22px; color: #333; width: 340px">
          Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quis, sequi impedit, eius non numquam officia nobis mollitia architecto minima ipsam iure laborum sit quasi voluptate nemo eligendi adipisci facere? Quo.
        </p>
        <v-card-actions class="d-flex justify-center align-center pt-10 w-100">
          <v-btn width="250" flat style="background-color: #2c6e63; color: #edf0ef; font-size: 16px; font-weight: 600; padding: 10px" size="x-large" to="/home2">Go back to web page</v-btn>
          <v-btn width="250" flat style="background-color: transparent color: #000000; border: 1px solid #000000; font-size: 16px; font-weight: 600; padding: 10px" size="x-large" @click="showModal=false">Got it</v-btn>
        </v-card-actions>
      </v-card>
    </v-dialog>
</div>
