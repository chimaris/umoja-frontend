...
font-size: 32px;
color: #1A1D1F;">Owner's Information</h1>
...
<div class="pt-8 pb-12" style="max-width:502px">
    <v-row class="">
      <v-col>
        ...
        <v-text-field v-model="firstName" placeholder="First name" density="comfortable">
        </v-text-field>
      </v-col>
      <v-col>
        <p class="inputLabel">Last Name</p>
        <v-text-field v-model="lastName" placeholder="Last name" density="comfortable">
        </v-text-field>
      </v-col>
    </v-row>
    ...
    <v-text-field v-model="phoneNumber" append-inner-icon="mdi mdi-phone-outline" placeholder="NG" density="comfortable">
    </v-text-field>
    <v-row>
      <v-col>
        <p class="inputLabel">Gender</p>
        <v-select v-model="selectedGender" :items="gender" append-inner-icon="mdi mdi-chevron-down" placeholder="Select gender" density="comfortable">
        </v-select>
      </v-col>
      <v-col>
        <p class="inputLabel">Date of Birth</p>
        <v-select v-model="selectedDateOfBirth" append-inner-icon="mdi mdi-chevron-down" placeholder="Select date" density="comfortable">
        </v-select>
      </v-col>
    </v-row>
    ...
    <v-row>
      <v-col>
        ...
        <v-select v-model="selectedFormOfId" :items="formOfId" append-inner-icon="mdi mdi-chevron-down" placeholder="Select" density="comfortable">
        </v-select>
      </v-col>
      <v-col>
        <p class="inputLabel">ID Number</p>
        <v-text-field v-model="idNumber" placeholder="Enter" density="comfortable">
        </v-text-field>
      </v-col>
    </v-row>
    
    <p class="inputLabel">Copy of ID</p>
    <v-card flat class="mb-8" style="justify-content: center; align-items: center; padding: 27px; display: flex; width: 100%; height: 100px; background: #F8F8F8; border-radius: 6px;">
...
export default {
    ...
    data() {
      ...
      phoneNumber: '08033685498',
      selectedGender: 'Male',
      selectedDateOfBirth: '2023-12-20',
      selectedFormOfId: 'National ID',
      idNumber: '2345676537',
          gender:['Male', 'Female'],
