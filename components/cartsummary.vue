...
<div class="d-flex w-100 align-center">
        ...
        <v-text-field  hide-details="" placeholder="Add discount code" density="comfortable"  >
        </v-text-field>
<v-btn flat   size="large" style="border: 1px solid var(--carbon-2, #CECECE);" class=" ml-3" rounded="xl">
