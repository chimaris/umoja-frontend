<template>
    ...
    <div class=" w-100 text-center">
        ...
        style="color: var(--magnetic-green-4, #2C6E63);
            ...
            text-transform: uppercase;" >What makes our Platform is so special?</p>
...
<div class=" pt-12" style="max-height:;width: 100%;position: relative;left: 0;bottom: 0;">
    ...
    <div class="d-flex" style="width: 100%;height: %;">
        ...
        <v-img class="discoimgs" eager width="70%" src="https://res.cloudinary.com/dd26v0ffw/image/upload/v1718893043/umoja-backup2/frame-1000006827_nwg6of_rxrgdr.png"></v-img>
        <div style="width: 70%;">

            <v-img eager class="smlimg" style="width: 56%;position: absolute;top: 3px;right: -26px;" width="60%" src="https://res.cloudinary.com/dd26v0ffw/image/upload/v1718893077/umoja-backup2/frame-1000006834_gzholy_zqzb5o.png"></v-img>
        </div>
    </div>
    </div>
</div>
        ...
        <v-col cols="12" md="6">
            ...
            <p style="color: var(--carbon-4, #FDF5ED);
font-size: 20px;
font-weight: 400;
line-height: 160%; /* 32px */
...
<div class=" pt-8" style="max-height:;width: 100%;position: relative;left: 0;bottom: 0;">
    <div class="" style="width: 100%;height: ;">
        ...
        <v-img class="discoimgs" eager width="100%" src="https://res.cloudinary.com/dd26v0ffw/image/upload/v1718893068/umoja-backup2/frame-1000006863_a92zuh_zcuntl.png"></v-img>
    ...
    opacity: 0.1;
    left: 26%;
" class="rotimg" src="https://res.cloudinary.com/dd26v0ffw/image/upload/v1718893096/umoja-backup2/Frame_3_rr0ci5_sufqim.png"></v-img>
             <v-row >
...
<v-img eager style="    scale: 1.5;
    position: relative;
   " class="customimgs" src="https://res.cloudinary.com/dd26v0ffw/image/upload/v1718893048/umoja-backup2/DASHBOARD_pcv7ef_atnth5.png"></v-img>
            </v-col>
 </v-row>
...
<div class=" pt-12" style="max-height:;width: 100%;position: relative;left: 0;bottom: 0;">
    ...
    right: -160px;" width="100%" class="imgs" src="https://res.cloudinary.com/dd26v0ffw/image/upload/v1718893053/umoja-backup2/orders_nagfeh_v86eb8.png"></v-img>
...
<div class=" pt-8" style="max-height:;width: 100%;position: relative;left: 0;bottom: 0;">
    ...
    " width="100%"  class="imgs" src="https://res.cloudinary.com/dd26v0ffw/image/upload/v1718893088/umoja-backup2/Sales_x325hs_cxhm8j.png"></v-img>
        ...
        <v-col cols="12">
            <v-card flat width="100%" style="padding-top:60px;border-radius: 15px;position: relative;" class="card2 px-10" color="#F38218" height="auto" >
                ...
                top: -38%;
                opacity: 0.1;
                left: 16%;" class="rotimg" eager src="https://res.cloudinary.com/dd26v0ffw/image/upload/v1718893063/umoja-backup2/vector_k3xdni_jwzsiw.png"></v-img>
             <v-row >
...
<v-img eager max-width="486px" height="auto" src="https://res.cloudinary.com/dd26v0ffw/image/upload/v1718893033/umoja-backup2/frame-1000007234_fqn6um_frecng.png"></v-img>
            </v-col>
 </v-row>
