<template>
	<div v-if="showBaloon" class="d-flex w-100" style="margin-top: 150px; background: #d92334; height: 49px; position: relative">
		...
		<img
			style="position: absolute; bottom: 0; left: 0px; width: 128px; height: auto"
			src="https://res.cloudinary.com/payhospi/image/upload/v1695047156/flag-2-b-gha-1hghc_nazbf1.png"
			alt=""
		/>

		<img
			style="position: absolute; bottom: 0; right: 0px; width: 128px; height: auto"
			src="https://res.cloudinary.com/payhospi/image/upload/v1695048168/flag-2-b-gha-2_tjp2yv.png"
			alt=""
		/>
	</div>
	<v-container id="footer" style="position: relative" :style="'max-width:' + maxw" :class="showBaloon ? '' : 'py-12'" class="pt-0 px-0 footbot" fluid>
		<v-card color="" :style="!showBaloon ? 'margin-top:100px' : ''" flat class="rounded-xl px-3" height="auto" min-height="1000px">
			<v-container style="max-width: 1400px" :class="showBaloon ? '' : 'pt-12'">
				...
				<v-row style="margin-bottom: 90px" class="row0 mt-12">
					<v-col cols="12" class="pt-0" lg="5">
						<v-avatar class="mb-4" style="width: 130px; height: 54px" rounded="0" flat>
							<v-img eager src="https://res.cloudinary.com/payhospi/image/upload/v1690545241/frame-4_q89xhq.png"> </v-img>
						</v-avatar>
						<p
							style="
								max-width: 377px;
								font-size: 14px;
								font-weight: 400;
								background: linear-gradient(90deg, #cecece 0%, rgba(206, 206, 206, 0.58) 100%);
						...
						<p class="mt-6" style="color: #000; font-size: 16px; font-weight: 600; line-height: 120%; /* 19.2px */ letter-spacing: -0.48px">
							Accepted Payments
						</p>
						<div class="mt-4" style="max-width: 230px">
							<v-row no-gutters>
								<v-col class="mb-1 pr-1" v-for="(n, i) in payms" :key="i" cols="3">
									<v-img width="100%" height="auto" :src="n"></v-img>
								</v-col>
							</v-row>
						</div>
					</v-col>
				...
				<p style="margin-top: ; color: var(--carbon-2, #000); font-size: 14px; font-weight: 400; line-height: 180%; /* 25.2px */">
					Umoja - Connecting you to Quality African Products Worldwide! Discover, buy, and sell authentic African products through our platform. Umoja
					directly connects users to vendors, providing a unique opportunity to explore diverse African cultures. With a customized Vendor Dashboard
					and an efficient order management system, you gain full transparency and control over your e-commerce business. Our integrated apps make
					managing your business seamless. Join Umoja today and experience the world of African goods at your fingertips!
				</p>
				<v-divider class="my-12" style="height: 2px" color="#"></v-divider>
					...
					<v-row>
						<v-col cols="12" class="d-flex align-center" md="3">
							...
							<v-btn size="small" variant="text"
								><v-icon color="green" size="18" class="mr-2" icon="mdi mdi-information"></v-icon>
								<span
									style="color: var(--carbon-4, #333); font-size: 14px; font-weight: 500; line-height: 120%; /* 16.8px */ letter-spacing: -0.42px"
								>
									Help Center</span
						...
						<v-col cols="12" class="d-flex align-center" md="3">
							<p class="" style="font-size: 14px; width: 100%; font-weight: 400; line-height: 180%; /* 25.2px */ letter-spacing: -0.42px">
...
export default {
	...
	data() {
		return {
			...
			payms: [
				"https://res.cloudinary.com/payhospi/image/upload/v1690546033/logo_kyqdsa.png",
				"https://res.cloudinary.com/payhospi/image/upload/v1690546096/frame-736_gvcp91.png",
				...
				"https://res.cloudinary.com/payhospi/image/upload/v1690546013/frame-736_cg1hxd.png",
				"https://res.cloudinary.com/payhospi/image/upload/v1690546013/frame-740_qvnaty.png",
				"https://res.cloudinary.com/payhospi/image/upload/v1690546012/frame-741_xorgm9.png",
			],
		};
	},
};
