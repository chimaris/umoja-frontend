...
font-weight: 400;"
									>
										select <span style="color: #1273eb"> click to browse </span>
									</p>
								</div>
							</div>
						</v-col>
...
font-weight: 400;"
					...
					<p style="color: #969696; font-size: 12px; font-weight: 400" class="mt-4">
						You need to add at least 4 images. Pay attention to the quality of the pictures you add, comply with background color standards. Pictures
						must be in certain dimensions. Notice that the product shows all the details.
					</p>
				</v-sheet>
				<v-sheet class="cardStyle mt-4">
					<div class="d-flex mb-4 align-center">
					...
					<div class="d-flex align-center justify-space-between">
						<p style="color: var(--carbon-4, #333); font-size: 14px; font-weight: 400; line-height: 24px">Total available product</p>
					...
					<div class="d-flex align-center justify-space-between">
						<p style="color: #333; font-size: 14px; font-weight: 400; line-height: 24px">Mininum Stock Notification</p>
						<div class="d-flex pa-1" style="border-radius: 6px; border: 1px solid #cecece; width: 141px">
							<v-text-field density="compact" hide-details variant="outline" value="0"></v-text-field>
							<div>
								<v-btn
			...
			<v-col cols="12" sm="4">
				...
				<v-sheet class="cardStyle px-0 mt-4">
					<div class="px-5">
						<div class="d-flex align-center">
							<p style="color: #333; font-size: 20px; font-weight: 600">Pricing</p>
						</div>
						<v-row class="mt-6">
							<v-col>
				...
				<v-sheet class="cardStyle mt-4">
					...
					<v-select class="mt-4" append-inner-icon="mdi mdi-chevron-down" placeholder="Fashion and style" density="comfortable"> </v-select>
					<p class="inputLabel">Sub Category</p>

					<v-select class="mt-4" append-inner-icon="mdi mdi-chevron-down" placeholder="Sneakers" density="comfortable"> </v-select>
					<p class="inputLabel">Gender</p>

					<v-select class="mt-4" append-inner-icon="mdi mdi-chevron-down" placeholder="Unisex" density="comfortable"> </v-select>
					...
					<div>
						<v-chip
							size="small"
							class="ma-1"
							style="border: 0.5px solid var(--magnetic-green-3, #94aaa5)"
