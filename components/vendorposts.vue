       ...
       <v-row style="background-color: #fff;">
        <v-col cols="12" v-for="(n, i) in items" :key="i" lg="4" md="6">
            <v-card flat style="border-radius: 15px;" class="bg-white rounded-lg ">
                ...
                <p v-if="n.oos" class="text-white py-1 px-3" rounded="lg"  style="font-size: 14px;
line-height: 17px;
position: absolute;right:12px;top:12px;border-radius: 3.34447px;background:rgba(0, 0, 0, 0.5)"  flat size="x-small">
1/2
            </p>
                </v-img>
      ...
      >
       ...
       <v-row style="height:70vh">
        <v-col cols="12"   class="px-0 py-0" md="6">
            <v-img cover width="100%" height="100%" src="https://res.cloudinary.com/payhospi/image/upload/c_fit,w_600/v1685878571/Rectangle_1903_2x_ssbqbl.png"></v-img>
        </v-col>
        <v-col cols="12" style="position: relative;" class="px-0 py-0" md="6">
            <v-sheet style="height: 100%;overflow: scroll;
    position: absolute;
    width: 100%;" class="py-2">
...
font-size: 16px;
line-height: 140%;
color: #1E1E1E;">Bonsu Thompson</p>
                        <p class="" style="font-weight: 400;
font-size: 14px;
line-height: 140%;
color: #969696;"><v-icon class="mx-1" icon="mdi  mdi-circle" size="6" color="grey-lighten-2"></v-icon>23 Nov, 2022</p>
                    </div>
                    <div class="d-flex">
                      <v-chip  size="x-small" class="px-3" color="#936900" rounded="0">Stylist</v-chip>
                        <p class="" style="font-weight: 400;
font-size: 14px;
color: #1E1E1E;"><v-icon class="mx-1" icon="mdi  mdi-circle" size="6" color="grey-lighten-2"></v-icon>042, Coal city state, Ghana</p>
                    </div>
                    </div>
                    <div class="pr-2">
...
font-size: 16px;
line-height: 140%;
letter-spacing: 0.03em;" >Lorem ipsum dolor sit amet consectetur. Nulla vitae mauris odio urna integer molestie laoreet. Enim viverra cursus imperdiet aliquam. Sed ut commodo diam est aenean at.</p>
            <div class="d-flex align-center py-2">
                    <v-btn  flat >
                        <v-icon class="mr-1" icon="mdi mdi-heart-outline"></v-icon> 1.2k likes
    
                    </v-btn>
                <v-btn  flat >
                    <v-icon class="mr-1" icon="mdi mdi-tray-arrow-up"></v-icon> Share Post
...
font-size: 24px;
line-height: 27px;
color: #000000;" class="pa-6">Related Products ({{ items.length }})</h1>
        </div>
        <v-divider></v-divider>
        ...
        <v-col  v-for="(n, i) in items" :key="i" cols="12">
            <v-card flat style="border-radius: 15px;border: 1px solid #F6F6F6;" class="bg-white rounded-lg pa-4">
                <v-row>
                    <v-col cols="5">    <v-img class="rounded-lg bg-grey-lighten-2" cover width="100%" height="160" :src="n.image">
                ...
                <v-icon size="x-small" color="#1C274C" icon="mdi mdi-heart-outline"></v-icon></v-btn>
                    ...
                    <v-col cols="7" class="pb-4">  <div  class="h-100" style="position: relative;">
