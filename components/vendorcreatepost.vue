    ...
    style="overflow:hidden;padding-bottom: 200px;max-width: 1330px;" flat>
        ...
        <div class="d-flex pb-8 pt-4 justify-space-between">
            <div class=" align-center">
                ...
                font-size: 16px;
                font-weight: 400;">
                Complete your post details, to engage with your audience</p>
                <div></div>
            </div>
        </div>
        <v-row>
...
<p class="mt-3" style="color:#969696;
font-size: 10px;
font-weight: 500;">SVG, PNF, JPG, or GIF (max 800X400px)</p>
</div>
</v-card>
    </v-col>
          ...
          <v-textarea counter="200" persistent-counter="" placeholder="Enter post text here" density="comfortable"  >
        </v-textarea>
        <v-divider class="my-4"></v-divider>
        <v-row class="mt-3">
                 <v-col> 
        <p class="inputLabel">Category</p>             
     <v-select placeholder="Select post category" append-inner-icon="mdi mdi-chevron-down"   density="comfortable"  >
         </v-select></v-col>
                 <v-col> 
                     <p class="inputLabel">Location</p>             
            
     <v-text-field placeholder="Enter location" density="comfortable"  >
         </v-text-field></v-col>
         </v-row> 
                </v-sheet>
                ...
                <v-sheet class="cardStyle mt-4 py-8">
                    <div class="d-flex  justify-space-between align-center">
                        <p style="color: #333;
                            font-size: 20px;
                            font-weight: 600;"> Add Related Products
                        </p>
                        <v-btn size="x-small" flat variant="text" color="blue"><span 
                        style="color:  #1273EB;
                        font-size: 14px;
                        font-weight: 500;">Add custom item</span> </v-btn>
                    </div>
