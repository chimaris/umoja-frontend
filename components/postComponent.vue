			...
			<div class="pl-1 w-100" style="min-width: 0">
				<div class="d-flex justify-space-between align-center w-100">
					<div class="d-flex align-center">
						<p style="color: #1e1e1e; font-size: 13px; width: 87px; font-weight: 600; line-height: 140%" class="text-truncate">
							{{ item.vendorName }}
						</p>
						<v-icon class="mx-1" size="3" color="grey-lighten-2" icon="mdi mdi-circle"></v-icon>
						<p style="color: #969696; font-size: 11px; font-weight: 400">3rd Nov, 2023</p>
					</div>
				...
				<div class="d-block mt-1">
					<div class="d-flex align-center">
						<v-chip style="justify-content: center; align-items: center; display: flex" color="#936900" size="x-small" rounded="lg">
							{{ item.vendorCategory }}</v-chip
						>
						<v-icon class="mx-1" size="3" color="grey-lighten-1" icon="mdi mdi-circle"></v-icon>
						<div class="text-truncate" style="color: #1e1e1e; font-size: 11px !important; font-weight: 400">Shaftesbury Avenue Accra, Ghana</div>
					</div>
				</div>
			</div>
		</div>
