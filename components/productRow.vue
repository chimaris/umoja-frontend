...
See All <v-icon class="ml-1" icon="mdi mdi-arrow-top-right"></v-icon>
  ...
  <div id="homepage" :style="vendorBol? 'height: 470px!important;' :showVendor? 'height: 545px!important;':  ''" style="   background: transparent!important;" :class="maxwidth == '1400px'? 'maxw':''" class="rower mt-8">
...
<product-component :cover="coverbol" :category="category" v-else :index="i" :showVendor="showVendor" :showdisco="showdisco" :item="n"  @add-to-cart="AddToCart(n)"  />
  </div>
