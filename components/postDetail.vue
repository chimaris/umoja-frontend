					...
					<v-sheet style="height: 100%; overflow: scroll; position: absolute; width: 100%" class="py-2">
						...
						<div class="px-6">
							<p style="font-weight: 400; font-size: 16px; line-height: 140%; letter-spacing: 0.03em">
								Lorem ipsum dolor sit amet consectetur. Nulla vitae mauris odio urna integer molestie laoreet. Enim viverra cursus imperdiet aliquam.
								Sed ut commodo diam est aenean at.
							</p>
