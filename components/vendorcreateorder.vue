<template>
	<v-container height="100%" class="mx-auto px-5" width="100%" style="overflow: hidden; padding-bottom: 200px; max-width: 1330px" flat>
		<v-alert v-if="false" class="text-white rounded-lg pa-6" color="#00966D"
			><div class="d-flex align-center" style="font-size: 14px; font-weight: 500; line-height: 20px">
				<v-icon class="mr-2" icon="mdi mdi-check-circle"></v-icon> Customer added sucessfully
			</div>
		</v-alert>
		<div class="d-flex pb-8 pt-4 justify-space-between">
			<div class="d-flex align-center">
				<h1 style="font-weight: 700; font-size: 24px; line-height: 30px; letter-spacing: -0.02em">Create Order</h1>
			...
			<v-col cols="12" sm="8">
				<v-sheet class="cardStyle">
					<div class="d-flex justify-space-between">
						<p style="color: #333; font-size: 20px; font-weight: 600; line-height: 20px; letter-spacing: -0.2px">Products</p>

						<v-btn variant="text" size="small" color="#1273EB">Add custom item</v-btn>
					</div>
					...
					>
						<thead>
							<tr style="background: #f8f8f8; border-radius: 4px">
								<th style="font-size: 14px; width: 100px" class="font-weight-medium text-left">Product</th>

								<th style="font-size: 14px" class="text-left px-1 font-weight-medium">Quantity</th>
						...
						<tbody>
							...
							<tr>
								<td style="position: relative; font-size: 14px; height: 100px">
									<div style="position: ; top: 24px; width: ">
										<div class="d-flex w-100 py-4">
											...
											></v-avatar>
											<div>
												<p class="mb-1" style="font-weight: 600; font-size: 14px !important; line-height: 20px; min-width: 220px; color: #1273eb">
													Multicolored Ankara Material from Ghana
												</p>
												<p style="font-weight: 500; font-size: 14px; line-height: 18px; color: #969696" class="mt-1 text-truncate">Small</p>
												<p style="font-weight: 500; font-size: 14px; line-height: 18px; color: #969696" class="mt-1 text-truncate">SKU: 5000</p>
												<p style="font-weight: 600; font-size: 14px; line-height: 18px; color: #1273eb" class="mt-1 text-truncate">€ 250.00</p>
											</div>
										</div>
									</div>
								</td>
								...
								<td class="tableThick px-1">
									<div class="h-100 py-4">€ 250.00</div>
								</td>
           ...
           <v-btn v-else color="green" size="small" class=" rounded-lg"> See details</v-btn>
				...
				<v-sheet class="cardStyle mt-4">
					<div class="d-flex mb-4 align-center">
						<p style="color: #333; font-size: 20px; font-weight: 600">Payment</p>
					</div>
					<div style="color: #969696; font-size: 14px; font-weight: 500; line-height: 24px; letter-spacing: -0.14px">
						<div class="d-flex mb-3 justify-space-between">
							<p>Subtotal</p>
							<p style="font-weight: 600; color: #333">€ 250.00</p>
						</div>
						<div class="d-flex mb-3 justify-space-between">
							<p>Add discount</p>
							<div class="d-flex w-75 justify-space-between">
								<p style="font-weight: 400; color: #333">----</p>
								<p style="font-weight: 600">€ 0.00</p>
							</div>
						</div>
						<div class="d-flex mb-3 justify-space-between">
							<p>Add shipping</p>
						...
						<div class="d-flex mb-3 justify-space-between">
							<p>Estimated tax</p>
							<div class="d-flex w-75 justify-space-between">
								<p style="font-weight: 400; color: #333">Not calculated</p>
								<p style="font-weight: 600">€ 0.00</p>
							</div>
						</div>
						<div class="d-flex mb-3 justify-space-between">
							<p style="font-weight: 600; color: #333">Total</p>
							<p style="font-weight: 600; color: #333">€ 250.00</p>
						</div>
					</div>
					<v-divider class="my-5"></v-divider>
					<p style="color: #333; font-size: 14px; font-weight: 500; line-height: 24px; letter-spacing: -0.14px">
						Add a product to calculate total and view payment options
					</p>
					<v-divider class="my-5"></v-divider>
					<p style="color: #969696; font-size: 14px; font-weight: 500; line-height: 24px; letter-spacing: -0.14px">
						Taxes may be estimates until the order is created. Learn more about <span style="color: #1273eb">estimated taxes</span>
					</p>
				</v-sheet>

				<v-sheet class="cardStyle mt-4 py-8">
					<div class="d-flex justify-space-between align-center">
						<p style="color: #333; font-size: 20px; font-weight: 600" class="align-center d-flex">
							<v-icon class="mr-2" size="small" icon="mdi mdi-list-box-outline"></v-icon>
							Email Invoice
						</p>
						<v-btn style="border: 1px solid #e5e5e5" size="large" variant="outlined">Send Invoice</v-btn>
					</div>
				</v-sheet>
				<v-sheet class="cardStyle mt-4 py-8">
					<div class="d-flex justify-space-between align-center">
						<p style="color: #333; font-size: 20px; font-weight: 600" class="align-center d-flex">
							<v-icon class="mr-2" size="small" icon="mdi mdi-credit-card-outline"></v-icon>
							Accept Payment
						</p>
					</div>
					<v-row class="mt-4">
				...
				<v-sheet class="w-100 mt-4 py-8">
					...
					<v-timeline density="compact" side="end">
						<v-timeline-item class="mb-12" fill-dot="" size="60">
							<template v-slot:icon>
								<v-avatar size="60" image="https://res.cloudinary.com/payhospi/image/upload/v1688715270/rectangle-22429_agrgwa.png"></v-avatar>
							</template>
							<div style="min-width: 500px" class="">
								<v-sheet class="cardStyle px-0 w-100 py-4">
									<div>
										<v-text-field placeholder="leave a comment..." hide-details variant="outlined"></v-text-field>
										<v-divider class="my-4"></v-divider>
										<div class="d-flex px-4 justify-space-between">
											<div style="font-size: 32px" class="d-flex align-center">
												<v-btn variant="text" icon flat class="mt-1"><span style="font-size: 32px">🙂</span></v-btn>
								...
								<p class="text-right" style="color: #969696; font-size: 14px; font-weight: 500; line-height: 24px; letter-spacing: -0.14px">
									<span style="color: #333; font-size: 14px; font-weight: 500; line-height: 20px">NB:</span> Only you and other staff can see comments
								</p>
							</div>
						</v-timeline-item>

						<v-timeline-item class="mb-6" hide-dot>
							<span style="color: #969696; font-size: 14px; font-weight: 500; line-height: 20px; letter-spacing: -0.14px">Today</span>
						</v-timeline-item>

						<v-timeline-item class="mb-4" dot-color="grey" size="x-small">
							<div style="min-width: 40vw" class="d-flex justify-space-between flex-grow-1">
								<div>
									<p class="timelinetext">You sent an invoice to Nweke Franklin (sylvesterfranklin007@gmail.com)</p>
								</div>
								<div class="flex-shrink-0">
									<p style="color: #969696; font-size: 14px; font-weight: 500; line-height: 20px">Just now</p>
								</div>
							</div>
						</v-timeline-item>
						<v-timeline-item class="mb-4" dot-color="grey" size="x-small">
							<div style="min-width: 40vw" class="d-flex justify-space-between flex-grow-1">
								<div>
									<p class="timelinetext">You created this draft order</p>
								</div>
								<div class="flex-shrink-0">
									<p style="color: #969696; font-size: 14px; font-weight: 500; line-height: 20px">Just now</p>
								</div>
						...
						<v-timeline-item class="" dot-color="grey" size="x-small">
							<div style="min-width: 40vw" class="d-flex justify-space-between flex-grow-1">
								<div>
									<p class="timelinetext">Order confirmation email was sent to Nweke Franklin (sylvesterfranklin007@gmail.com)</p>
								</div>
								<div class="flex-shrink-0">
									<p style="color: #969696; font-size: 14px; font-weight: 500; line-height: 20px">Just now</p>
								</div>
						...
						<v-timeline-item class="mb-4" hide-dot>
							<v-btn style="border: 1px solid #e5e5e5" size="large" variant="outlined">Resend Email</v-btn>
						</v-timeline-item>

						<v-timeline-item class="" dot-color="grey" size="x-small">
							<div style="min-width: 40vw" class="d-flex justify-space-between flex-grow-1">
								<div>
									<p class="timelinetext">Confirmation #M5QJPMWCC was generated for this order.</p>
								</div>
								<div class="flex-shrink-0">
									<p style="color: #969696; font-size: 14px; font-weight: 500; line-height: 20px">Just now</p>
								</div>
			...
			<v-col cols="12" sm="4">
				<v-sheet class="cardStyle">
					<div class="d-flex mb-6 mt-2 justify-space-between align-center">
						<p style="color: #333; font-size: 20px; font-weight: 600">Customer</p>
						<v-btn @click="dialog = true" size="x-small" flat icon="mdi mdi-close-circle-outline" variant="text" color="blue"></v-btn>
					</div>
					<v-text-field
						v-if="false"
						hide-details=""
						class="borderedinput w-100 my-4"
						variant="outlined"
						prepend-inner-icon="mdi mdi-magnify"
					...
					<div class="mb-4 d-flex justify-space-between">
						...
						<div>
							<v-icon size="18" class="mb-1" icon="mdi mdi-shopping"></v-icon>
							<span style="color: #1273eb; font-size: 14px; font-weight: 600; line-height: 26px"> 4 Orders </span>
						</div>
					</div>
					...
					<p
						...
						"
					>
						Nweke Franklin Odira
					</p>

					<v-divider class="my-4"></v-divider>
					<div class="d-flex justify-space-between align-center">
						<p style="color: #333; font-size: 20px; font-weight: 600">Contact Information</p>
						<v-btn size="x-small" flat variant="text" color="blue"
							><span style="color: #1273eb; font-size: 14px; font-weight: 500">Edit</span>
						</v-btn>
					</div>
					<div class="mt-4 d-flex justify-space-between">
						<p style="color: #1273eb; font-size: 14px; font-weight: 500; line-height: 20px">Sylvesterfranklin@gmail.com</p>
						<v-btn size="x-small" flat variant="text" icon="mdi mdi-content-copy" color="grey-lighten-1"> </v-btn>
					</div>
					<p style="color: #969696; font-size: 14px; font-weight: 500">No phone number</p>
					<v-divider class="mt-4 mb-4"></v-divider>
					<div class="d-flex justify-space-between align-center">
						<p style="color: #333; font-size: 20px; font-weight: 600">Shipping Address</p>
						<v-btn size="x-small" flat variant="text" color="blue"
							><span style="color: #1273eb; font-size: 14px; font-weight: 500">Edit</span>
						</v-btn>
					</div>
					<div class="mt-4 d-flex justify-space-between">
						<p style="color: #969696; font-size: 14px; max-width: 180px; font-weight: 500; line-height: 20px">
							Michael Johnson Michael’s Corp LLC Rose Str. 120 New York, PH 10000 United States (US)
						</p>
						<v-btn size="x-small" flat variant="text" icon="mdi mdi-content-copy" color="grey-lighten-1"> </v-btn>
					</div>

					<v-btn variant="text" flat class="px-0 mt-2" size="x-small">
						<span style="color: #1273eb; font-size: 14px; font-weight: 600; line-height: 140%; text-decoration-line: underline"> View Map </span>
					</v-btn>

					<v-divider class="my-4"></v-divider>
					<div class="d-flex justify-space-between align-center">
						<p style="color: #333; font-size: 20px; font-weight: 600">Billing Address</p>
						<v-btn size="x-small" flat variant="text" color="blue"
							><span style="color: #1273eb; font-size: 14px; font-weight: 500">Edit</span>
						</v-btn>
					</div>

					<p class="mt-4" style="color: #969696; font-size: 14px; font-weight: 500">Same as shipping address</p>
				</v-sheet>
				<v-sheet class="cardStyle mt-4">
					<div class="d-flex mb-6 mt-2 justify-space-between align-center">
						<p style="color: #333; font-size: 20px; font-weight: 600">Notes</p>
						<v-btn icon="mdi mdi-plus" variant="outlined" size="small" style="border: 1px solid #e5e5e5" class="rounded-xl"></v-btn>
					</div>
					<v-text-field hide-details="" class="borderedinput w-100 mt-4" variant="outlined" placeholder="Start writing" density="compact">
					</v-text-field>
				</v-sheet>
				<v-sheet class="cardStyle mt-4">
					<div class="d-flex mb-6 mt-2 justify-space-between align-center">
						<p style="color: #333; font-size: 20px; font-weight: 600">Tags</p>
						<v-btn variant="text" size="small" color="#1273EB">View all tags</v-btn>
					</div>
					<v-text-field hide-details="" class="borderedinput w-100 mt-4" variant="outlined" placeholder="Find or create tags" density="compact">
					</v-text-field>
				</v-sheet>
			</v-col>
		</v-row>
