...
rowor: #1A1D1F;" class="mt-5">Dashboard</h2>
        ...
        group
      >
        <v-btn :ripple="false" text  style="
" class="mr-3 rounded-xl " value="1">
          Last 24hrs
        </v-btn>

        <v-btn :ripple="false" text  class="mr-3 rounded-xl" value="2">
          Last Week
        </v-btn>

        <v-btn :ripple="false" text  class="mr-3 rounded-xl" value="3">
          Last Month
        </v-btn>

        <v-btn :ripple="false" text  class="mr-3 rounded-xl" value="4">
          Last Year
        </v-btn>
      </v-btn-toggle>
            ...
            <v-col cols="5">
                <div class="mt-3" v-for="n in countries" :key="n.name">
                    <div class="d-flex mb-1 align-center">
                        ...
                        <p style="font-weight: 500;
font-size: 16px;" class="ml-3 text-capitalize">{{ n.name }}</p>
                    </div>
                    <div class="d-flex align-center">
                       <div style="width: 80%;">

                           <v-progress-linear style="width:100%;border-radius: 5px;" class="mr-2" color="#1361F4" :model-value="n.growth" :height="6"></v-progress-linear>
                        </div> 
                        <p
    style="font-weight: 500;
font-size: 16px;
line-height: 20px;
color: #969696;" class="ml-4">{{ n.growth }}%</p>
                    </div>
                </div>
            </v-col>
        </v-row>
...
<v-icon size="12" class="mr-1" icon="mdi mdi-map-marker"></v-icon>United States</p>
    ...
    <v-col cols="12" lg="4">
        ...
        <div class="d-flex justify-space-between">
            ...
            <v-btn variant="text" color="#1361F4" >
View more            </v-btn>
        </div>
