...
color: #969696;"> 72 products found</p>
    ...
    height="160" class="promo"
     :show-arrows="false" hide-delimiter-background="" cycle>
      <v-carousel-item 
        v-for="n in 6"
      >
      <v-img cover height="160px" class="bg-black d-flex align-center rounded-lg" src="https://res.cloudinary.com/payhospi/image/upload/c_fit,w_1000/v1684602013/Rectangle_458_zafbwy.png">
        <div>
