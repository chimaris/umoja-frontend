<template>
    <v-card width="254" v-if="loaded" style="overflow: visible;" flat class="bg-white parent-card rounded-lg mb-2">
        <v-img eager class=" bg-grey-lighten-5" cover style="border-radius: 16px;" width="100%" height="237" :src="item.image">
        </v-img>
<div class="px-4">

        <v-avatar style="    margin-top: -37px;" size="67">
        <v-img eager class=" bg-grey-lighten-2" cover style="border-radius: 16px;" width="100%" height="237" :src="item.vendorImage">
        </v-img>
        </v-avatar>
    ...
    color: #000000;
    " class=" mt-4">{{item.vendorName}}</p>
      <div class="d-block   mt-1">
   <div class="d-flex align-center">
    <p style="color: #969696;
            font-size: 14px;
            font-weight: 500;
            line-height: 140%;" class="text-capitalize">{{category}}</p> 
       <v-icon class="mx-1" size="5" color="grey-lighten-1" icon="mdi mdi-circle"></v-icon>
       <p 
            style="color: #969696;
            font-size: 14px;
            font-weight: 500;
            line-height: 140%;">  {{item.subCategory}}</p>
   </div>
    </div> 
   <p style="font-weight: 600;
    ...
    " class="d-flex mb-1 pb-0 pt-1 align-center">
        ...
        size="x-small"
        ></v-rating><span style="margin-left:3px;margin-top: 3px ;" >(101)</span> 
    </p>
    <div variant="text" size="x-small" style="font-size: 12px;
font-weight: 500;border-radius: 6px;color: #F38218;
