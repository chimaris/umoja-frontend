<template>
	<v-card :width="$vuetify.display.mobile ? 184 : 254" v-if="loaded" style="overflow: visible" flat class="bg-white parent-card rounded-lg mb-2">
		...
		<div class="px-4">
			...
			<div class="d-block mt-1">
				<div class="d-flex align-center">
					<p style="color: #969696; font-size: 14px; font-weight: 500; line-height: 140%" class="text-capitalize">{{ category }}</p>
					<v-icon class="mx-1" size="5" color="grey-lighten-1" icon="mdi mdi-circle"></v-icon>
					<p style="color: #969696; font-size: 14px; font-weight: 500; line-height: 140%">{{ item.subCategory }}</p>
				</div>
			</div>
			...
			<div variant="text" size="x-small" style="font-size: 12px; font-weight: 500; border-radius: 6px; color: #f38218; letter-spacing: -0.12px">
