<template>
    ...
    <v-container class="pt-0" style="max-width: 1300px;">
     ...
     <span v-if="item.disabled" style="color:  #2C6E63;
font-size: 14px;
font-weight: 600;
...
letter-spacing: -0.84px;">Green and brown kente scarf material, Made in Lagos Nigeria.</p>
...
font-size: 14px;
font-weight: 500;
letter-spacing: 0.7px;" class="mt-2 ml-3">4.0</p>
  </div>
<p style="color: var(--carbon-6, #1E1E1E);
font-size: 36px;
font-weight: 600;
line-height: 140%;" class="my-4">€ 2500.00</p>
<div class="d-flex mb-2 align-center">
<p style="color: #1E1E1E;
font-size: 14px; 
font-weight: 600;
line-height: 140%; ">Available Size</p>
<v-btn class="ml-1" variant="text" color="#969696"><span>Size Guide</span> <v-icon class="ml-1" icon="mdi mdi-arrow-right"></v-icon></v-btn>
</div>
...
letter-spacing: -0.48px;">Description: 
            </p>
                <p style="color: #333;
font-size: 14px;
font-weight: 400;
...
font-weight: 600;
line-height: 180%; /* 28.8px */
letter-spacing: -0.48px;">Specification:
        </p>
    <ul style="color: #333;
        font-size: 14px;
...
font-weight: 600;
line-height: 140%; /* 39.2px */
letter-spacing: -0.84px;">Item Rating/Reviews</p>
...
letter-spacing: -0.14px;">49 Ratings</p>
</div>
    ...
    font-weight: 600;">
                ...
                <v-progress-linear
                :model-value="(20 * n)- 5" style="width: 100%;left: 70px;"
                color="green" class="linearl"
                height="6" rounded
                >    
    </v-progress-linear>
    </div>
...
font-weight: 500;
line-height: 140%;
letter-spacing: -0.14px;">All Reviews <span style="color: #969696;
">(120)</span></p>
<v-chip-group variant="outlined"
    mandatory style="font-size: 14px;
line-height: 17px;font-weight: 500;
letter-spacing: 0.03em;
color: #333333;" class=" text-grey"
v-model="chip" 
          selected-class=" chipselected3"
          >
          <v-chip :class="chip == tag.name? 'chipselected3':' '"  style="font-size: 14px;font-weight: 500;"
          size=""  class="pa-2 px-4 "
            v-for="tag in tags"
            :key="tag.name"
          >
...
color: #969696;">🇺🇸 USA, New York City</p>
       ...
       :model-value="4"
        ...
        active-color="#E7CE5D"
        class="rts mr-4" density="comfortable"
        size=""
        ></v-rating>
            <p style="color:  #969696;
font-size: 12px;
font-weight: 500;
letter-spacing: 0.6px;">13/6/2017, 8:23 PM</p>
           </div>
           </div>
           <div>
           <p style="color: #333;
font-size: 16px;
font-weight: 600;" class=" mt-4 mb-2">The product really giving if you ask me</p>
<p style="color: #333;
font-size: 14px;
line-height: 140%;" class="px-">Lorem ipsum dolor sit amet consectetur. Lobortis sagittis porta tincidunt nibh eget lacus. Tristique tellus tempus dolor semper aliquam amet ipsum at. Ultricies porttitor sceler... 
<span style="color: #1273EB;font-weight: 600;">
    Read More
</span></p>

 <div class="mt-2">
        <v-btn variant="text" class="pl-0" >
            <v-icon icon="mdi mdi-heart-outline" class="mr-2" size="17"></v-icon><span 
        style="
    font-size: 14px;
    font-weight: 600;">Like</span> </v-btn>
        <v-btn variant="text"  class="ml-2" >
            <v-icon icon="mdi mdi-share-outline" class="mr-2" size="17"></v-icon>
            <span 
        style="
    font-size: 14px;
    font-weight: 600;">Reply</span> </v-btn>
    </div>
</div>
<v-divider color="#EDEDED"  class=" mt-4"></v-divider></div>

    </div>
    <div class="my-8">
        <p style="font-size: 20px;
font-weight: 600;" class="inputLabel d-flex align-center">Review this product <v-icon size="18" class="ml-2" icon="mdi mdi-information"></v-icon></p>
...
<v-col cols="12" lg="4">
  ...
  <v-card flat class=" pa-0 cardStyle">
    <div style="background-color: #EDF3F0;height: 40px;" class="d-flex align-center justify-center w-100">
        <p style="color: #00966D;
font-size: 14px;
font-weight: 600;
line-height: 140%; ">Available</p>
    </div>
    <div class="px-6 py-4">
...
font-size: 14px;
font-weight: 500;
line-height: 140%;">Quantity: <span style="color: #000;">2</span></p>
...
<span style="
font-size: 14px;
font-weight: 600;">Buy Now</span></v-btn>
<div class="d-flex mt-4 justify-space-between">
    <v-btn  width="48%" variant="text"  class="" >
        ...
        style="
    font-size: 14px;
    font-weight: 600;">Favorite</span> </v-btn>
    ...
    <v-btn  width="48%" variant="text"  class="" >
        ...
        style="
    font-size: 14px;
    font-weight: 600;">Share</span> </v-btn>
</div>
    </div>
  </v-card> 
  <v-card flat class=" mt-4 py-9 cardStyle">
    <div class="d-flex justify-space-between align-center">
        <p style="color: #1E1E1E;
font-size: 14px;
font-weight: 600;">Ship to</p>
        <p style="color: #1273EB;
font-size: 14px;
font-weight: 500;"><v-icon class="mb-1 mr-1" size="14" color="black" icon="mdi mdi-map-marker"></v-icon>United States 🇺🇸</p>
    </div>
...
font-size: 20px;
font-weight: 600;
line-height: 140%;">Delivery Options</p>
<div style="color: var(--carbon-6, #1E1E1E);
font-size: 14px;
...
<p>
    From Ghana to United States of America via <strong>

        Umoja standard shipping
    </strong>
</p>
<p>Etimated delivery <strong>
...
export default {
    ...
    data() {
        ...
        { label: "Use", value: "Bag, Bedding, Cover, Curtain, Dress, Garment, Home Textile, Industry, Interlining, Military, Pillow, Shirt, Tent, Wedding" },
