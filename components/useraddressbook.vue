...
font-weight: 600;">
   ...
   <template v-if="shippingAddress.length >= 1">
    ...
    <div>
        ...
        <v-btn @click="deleteAdd(address.id)" variant="outlined" color="red" flat style="border: 1px solid var(--carbon-2, #CECECE);" class=" ml-2" rounded="xl">
...
font-weight: 600;">Add New Address</p>
    ...
    <v-form v-model="valid2" @submit.prevent="updateAddress">
        <v-row>
            ...
            <v-col cols="12" md="6">
                <p class="inputLabel">Phone Number<span class="mb-2">*</span></p>             
                <v-text-field :rules="phoneRules" v-model="selectedEdit.phone_number" placeholder="Enter your phone number (only digits)" density="comfortable"  >
                </v-text-field></v-col>
        </v-row>                  
        <p class="inputLabel">Street Name and House Number*<span class="mb-2">*</span></p>             
        <v-text-field :rules="inputRules" v-model="selectedEdit.shipping_address" placeholder="Enter your Street Name and House Number" density="comfortable">
        </v-text-field>
         <v-row class="">
            <v-col cols="12" md="6"> 
                <p class="inputLabel">Country<span class="mb-2">*</span></p>             
         ...
         <v-row class="">
            ...
            <v-col cols="12" md="6">
                <p class="inputLabel">Postal code<span class="mb-2">*</span></p>                    
                <v-text-field v-model="selectedEdit.shipping_postal_code" placeholder="Enter your zipcode" density="comfortable"  >
                </v-text-field> 
            </v-col>
         </v-row>               
...
#C20052">
    ...
    <v-card-actions class="justify-center w-100">
      ...
      <v-btn rounded="xl" size="x-large" style="background-color: #C20052; color: #fff;  flex: 1" @click="deleteShippingAddress(deleteId)">Delete</v-btn>
    </v-card-actions>
  </v-card>
</v-dialog>
