        ...
        <div v-for="n in ['Shipped', 'Processed']">
            ...
            <div class="px-6 py-6">
                <v-row>
                    ...
                    <v-col class="pr-8" cols="11">    <p style="color: var(--carbon-6, #1E1E1E);
font-size: 14px;
font-weight: 500;" class="">
        Your Order
        <strong> #ID25725728RS</strong>
          placed on 19-08-23, containing 4 items have been
           <strong>{{n}}. </strong>
            <span style="color: #1273EB;text-decoration-line: underline;">Tap to see order details  
            </span>
    </p>
<p style="color: var(--carbon-6, #1E1E1E);
font-size: 12px;
font-weight: 500;" class="mt-2">Just Now</p></v-col>
                </v-row>
<div>
...
The African fashion Line
</strong>  just made a new post</p>
            <p 
            style="color: #969696;
            font-size: 14px;
            font-weight: 500;">“Look splendid while rocking our new product in the market. The multicolored Ankara...</p>
<p style="color: var(--carbon-6, #1E1E1E);
font-size: 12px;
font-weight: 500;" class="mt-2">Just Now</p></v-col>
