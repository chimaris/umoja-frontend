	...
	<div>
		...
		<v-row style="background-color: #fff">
			<v-col cols="12" v-for="(n, i) in items" :key="i" lg="4" md="6">
				<v-card flat style="border-radius: 15px; border: 1px solid #cecece" class="bg-white rounded-lg">
		...
		<v-dialog v-model="dialog" transition="dialog-bottom-transition" width="auto">
			<v-card max-width="700px" min-width="60vw" class="rounded-lg">
				<v-row>
					<v-col cols="12" class="px-0" style="min-height: 400px" md="6">
						<v-img
							cover
							height=""
						...
						<v-sheet class="py-0">
							...
							<div class="px-5">
								...
								<div class="d-flex justify-space-between align-center py-2">
									<div><v-icon icon="mdi mdi-heart-outline"></v-icon> 1.2k likes</div>
									<v-btn icon="mdi mdi-tray-arrow-up" flat></v-btn>
								</div>
							</div>

							<v-divider></v-divider>
							<div>
								<h1 style="font-weight: 700; font-size: 24px; line-height: 27px; color: #000000" class="pa-5">Products</h1>
							</div>
							<v-divider></v-divider>
						</v-sheet>
					</v-col>
