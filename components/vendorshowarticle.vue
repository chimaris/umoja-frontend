	...
	<v-container height="100%" class="mx-auto px-5" width="100%" style="overflow: hidden; padding-bottom: 200px; max-width: 1330px" flat>
	  ...
	  <v-row>
		<v-col cols="12" v-for="(n, i) in allArticle" :key="i" lg="4" md="4">
		  <div class="cardStyle d-flex flex-column">
			...
			<p class="mt-4 mb-2" style="color: var(--carbon-4, #333); display: -webkit-box; -webkit-line-clamp: 1; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis; font-size: 20px; font-weight: 700; line-height: 140%">
			  {{n.title}}
			</p>
			<div v-html="n.content" class="article-content flex-grow-1" style="display: -webkit-box; -webkit-line-clamp: 4; -webkit-box-orient: vertical; overflow: hidden; text-overflow: ellipsis"></div>
		  </div>
		</v-col>
	  </v-row>
	</v-container>
