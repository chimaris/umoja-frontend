...
font-size: 96px;
line-height: 101px;
letter-spacing: 0.03em;" class=" mb-0 text-white font-weight-black">The Agojie
Carved Mask</h1>
...
border-radius: 20px;" class="d-flex align-center mb-2 pa-4">
<v-avatar size="50" class="mr-4"><v-img src="https://res.cloudinary.com/payhospi/image/upload/v1684658586/Frame_481586_piaotu.png"></v-img></v-avatar> 
...
color: #333333;">products</p> 

<v-btn size="small" class="font-weight-medium textClass px-4" rounded flat variant="text" color="#1273EB">Explore the product market place <v-icon class="ml-2" icon="mdi mdi-arrow-right"></v-icon></v-btn>
         </div>
    <v-divider></v-divider>
...
text-transform: uppercase;
color: #333333;" class=" text-uppercase"
v-model="chip"
          selected-class=" chipselected"
          >
          <v-chip :class="chip == tag.name? 'chipselected':''"  style="font-size: 14px;"
          size="large"  class=" pa-4"
            v-for="tag in tags"
            :key="tag.name"
          >
