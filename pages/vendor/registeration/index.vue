...
" class="my-12 text-center">Select a sign up category</p>
    <v-card flat  @click="$router.push('/user/signup')"
 style="height: 169px;
    max-width: 859px;
    width: 616px;" class="mb-8 py-4 rounded-lg pa-6 d-flex align-center">
...
font-size: 24px;
line-height: 30px;
color: #333333;">Sign Up as a Customer</p>
        <p style="font-weight: 400;
font-size: 16px;
line-height: 20px;max-width: 317px;
color: #333333;
">Lorem ipsum dolor sit amet consectetur. Sit urna neque pellentesque at cras.</p>
    </div>
    <v-img class="signupimg" src="https://res.cloudinary.com/payhospi/image/upload/v1686202938/Frame_yg0jej.png"></v-img>
</v-card>
<v-card style="height: 169px;
    max-width: 859px;
    width: 616px;
" flat @click="$router.push('/vendor/registeration/form')" class=" mb-4 rounded-lg pa-6 d-flex align-center">
    <v-avatar size="80" class="mr-6"  variant="tonal" color="green">
...
font-size: 24px;
line-height: 30px;
color: #333333;">Sign Up as a Vendor</p>
        <p style="font-weight: 400;
font-size: 16px;
line-height: 20px;
color: #333333;max-width: 317px;
">Lorem ipsum dolor sit amet consectetur. Sit urna neque pellentesque at cras.</p>
    </div>
