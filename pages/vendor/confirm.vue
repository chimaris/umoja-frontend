...
color: #0F0C22;
 ">Almost done. Confirm your email.
             ...
             <p class="my-6" style="font-style: normal;
font-weight: 500;
font-size: 16px;
line-height: 24px;
/* or 150% */
...
color: #596066;">We’ve sent a verification link to your email address. 
                Click on the link to verify your email address.
                 If you didn’t get the email, check your spam folder or resend the link.
</p>
 

           <v-btn to="/vendor/forgot" width="295" color="green" flat size="x-large" class="rounded-lg"> 
