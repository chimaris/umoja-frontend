<template>
    ...
    z-index: 999;">
        <v-container style="max-width:1200px;width: 100%;" class="py-1">
            <div class="d-flex">
                <p style="cursor: pointer;font-size: 14px;" :class="select == n ? 'text-green font-weight-bold' : ''"
                    @click="selectCategory(n)" class="font-weight-medium text-capitalize py-3 px-4 mr-4 text-grey"
                    v-for="n in ['fashion', 'art', 'cosmetics', 'home decoration']" :key="n">{{ n }}</p>
            </div>
        </v-container>
    </div>
    ...
    <PostsRow style="margin-bottom: 100px;" :maxwidth="'1200px'" :showVendor="true" 
    :title="databank.postRow.title" 
             :items="databank.postRow.items"
     />
        ...
        databank() {
            var fashion = {
                ...
                menu: [
                    {
                        name: 'Men Clothes',
                        leftimage: 'https://img.freepik.com/free-photo/autumn-person-with-beautiful-hat_23-2149137832.jpg?w=900&t=st=1695372157~exp=1695372757~hmac=fdd7dd407529348c4a3b2461b3160ea1e54bb213492fa6304d389c3788d8420e',
                        rightimage: 'https://img.freepik.com/free-photo/portrait-young-handsome-male_23-2148884407.jpg?w=996&t=st=1695372208~exp=1695372808~hmac=d4ebb4f3c1aff10fb97701a6dcd9d3afc0268c39b560a1169b2641ac49776d2d',

                    },
                    {
                        name: 'Female Clothes',
                        leftimage: 'https://img.freepik.com/free-photo/fashionable-young-seductive-african-model-with-perfect-curly-hairs-elegant-orange-blouse-silk-pants-sitting-vintage-chair-beige-wall_273443-4086.jpg?w=2000&t=st=1695372432~exp=1695373032~hmac=840219d7884c18409efb09c563761f51f863b4259852ccd665cba251cb685177',
                        rightimage: 'https://img.freepik.com/free-photo/portrait-african-woman-floral-coat_23-2148747911.jpg?w=1380&t=st=1695372536~exp=1695373136~hmac=216d5903edbaa030bbf8c6515a61c0db3508f6bdc77065ad623a0b3ff01558d3',

                    },
                    {
                        name: 'Shoes',
                        leftimage: 'https://img.freepik.com/free-photo/still-life-say-no-fast-fashion_23-2149669605.jpg?w=2000&t=st=1695372814~exp=1695373414~hmac=c7fa397f2aa7c60e7b917602863fd36edb562c3830cb22c3a1c72181025382ac',
                        rightimage: 'https://img.freepik.com/free-photo/closeup-leather-high-heeled-female-brown-shoes-decorated-with-metal-parts_181624-32288.jpg?size=626&ext=jpg',
                    ...
                    {
                        name: 'Hats',
                        leftimage: 'https://img.freepik.com/free-photo/portrait-stylish-man-wearing-nice-hat_23-2148634028.jpg?w=2000&t=st=1695372893~exp=1695373493~hmac=552eda388948220123de986ab18cbd1aeeecdc6286e9cdbc466903c3befd443a',
                        rightimage: 'https://img.freepik.com/free-photo/portrait-fashionable-man-smiling-outdoors_23-2148448887.jpg?w=2000&t=st=1695372927~exp=1695373527~hmac=2f2f1ec9f3ad097ad8d83b8030f2e05dc3810d68ab7fad08b517671eeafe9087',

                    },
                    {
                        name: 'Materials',
                        leftimage: 'https://img.freepik.com/free-photo/fabric-texture-background_1385-1944.jpg?w=1380&t=st=1695372981~exp=1695373581~hmac=c96a08912f0b5c11dc1103634b55c6b5149d54546a08dcb39734fb1656c9765e',
                        rightimage: 'https://img.freepik.com/free-photo/stack-sweatshirts_23-2148175734.jpg?w=900&t=st=1695373131~exp=1695373731~hmac=a2f111e2be2ddaeeb18f7166c53259d5a4f5892a556dbade4f273ffd35dc0732',
  ...
  },
  {
    name: 'Decorative Ads',
        ...
        oos: true},
            ...
            var cosmetics = {
                ...
                rightimage: 'https://res.cloudinary.com/payhospi/image/upload/v1694074699/rectangle-22449cosme23_afjd41.png',
                        ...
                        { name: 'Facial Care', 
                leftimage: 'https://img.freepik.com/free-photo/black-girl-with-towel-head-has-eye-patches-isolated-white-background_1157-52269.jpg?w=2000&t=st=1695374399~exp=1695374999~hmac=6305f06029c00ea4e1086e77ae24c633c9813bd7962d96c337e242439f44e7c3',
                rightimage: 'https://img.freepik.com/free-photo/black-girl-with-towel-head-has-eye-patches-isolated-white-background_1157-52274.jpg?w=2000&t=st=1695374439~exp=1695375039~hmac=b04041f230dcb7c69c559d4fcb702e4389814f245b9e2a6ea5f147795519fa8b',
                    },
                        { name: 'Serums', 
                leftimage: 'https://img.freepik.com/free-photo/portrait-woman-with-face-serum-beauty_23-2150571358.jpg?w=900&t=st=1695374467~exp=1695375067~hmac=4c6eb38e452b22b959ed0cb440739a5cf0c8b4287614cf0ebccbf65bf1cc245e',
                rightimage: 'https://img.freepik.com/free-photo/close-up-man-applying-serum_23-2149137922.jpg?w=900&t=st=1695374960~exp=1695375560~hmac=56565b59888bca3349325c2334792112a5a775bcdf7121d4c0a4e27e51f70b58',
                    },
                        { name: 'Shaving & Beard Care', 
                leftimage: 'https://img.freepik.com/free-photo/young-afro-american-man-shaving-bathroom-personal-morning-routine-hygiene-morning-concept_1258-105006.jpg?w=2000&t=st=1695374600~exp=1695375200~hmac=d09b8ee41151105038be9567c3ee1b9c00b4480340cac4a0896e74d9235322bd',
                rightimage: 'https://img.freepik.com/free-photo/young-male-doing-selfcare-routine_23-2149291811.jpg?w=900&t=st=1695374638~exp=1695375238~hmac=a20b533407e6a389c8e9c95c2758da9b491c4b0c1507497270a967873a87d7bf',
                    },
                        { name: 'Body Care', 
                leftimage: 'https://img.freepik.com/free-photo/african-american-woman-wearing-towel-doing-her-daily-skincare-routine-home_155003-32987.jpg?w=900&t=st=1695374709~exp=1695375309~hmac=759cb8ca403d7846dfeb950d88cec13fb6319839c49ee6ba24382a82dd54fdac',
                rightimage: 'https://img.freepik.com/free-photo/medium-shot-man-using-shaving-cream_23-2149137926.jpg?w=1800&t=st=1695374683~exp=1695375283~hmac=593841d34ee2be0335bacab585f61a8968fbdc496492d7212dd2bab5d9a19014',
                    },
                        { name: 'Hair Care', 
                leftimage: 'https://img.freepik.com/free-photo/smiley-young-woman-styling-hair-medium-shot_23-2149634972.jpg?w=2000&t=st=1695374816~exp=1695375416~hmac=5b24286aaf1938774faa2b123ddd873a47df79876bf62fd274257cb782a5172d',
                rightimage: 'https://img.freepik.com/free-photo/young-man-posing-studio-medium-shot_23-2149457592.jpg?w=900&t=st=1695374875~exp=1695375475~hmac=0809263d87dbf02271e37ce27258495d942277f4ca0bb9ce9938d06d85296e36',
                        }
                        ],
                vendor:{
        ...
        oos: true},
            ...
            return this.select == 'fashion' ? fashion :
                this.select == 'art' ? art :
                    this.select == 'cosmetics' ? cosmetics :
                        this.select == 'home decoration' ? decoration : fashion
        },
        select() {
            return this.$route.params.name
        },
        categoryColor() {
            return this.select == 'fashion' ? 'EDF0EF' :
                this.select == 'art' ? 'FDF1ED' :
                    this.select == 'cosmetics' ? 'FDF5ED' :
                        this.select == 'home decoration' ? 'EDEDED' : 'EDF0EF'
        }
    },
    mounted(){
        this.imgloader()
