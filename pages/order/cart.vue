...
<v-card class="overflow-visible" flat  color="#F7F7F7" min-height="" width="100%">
        <v-card flat style="border-radius: 10px;" class="pt-8 px-4">
...
<v-col cols="3">
    ...
    <v-img cover class="rounded-lg" width="100%" height="180" src="https://res.cloudinary.com/payhospi/image/upload/v1684602010/Rectangle_459_1_wnr1ld.png"></v-img>
</v-col>
<v-col cols="6">
...
<v-col cols="3">
    <h1 class="text-right bigpriceClass">$150</h1>
</v-col>
        </v-row>
...
line-height: 20px;
text-transform: uppercase;
color: #333333;" class="mt-8 mb-4">cart summary</p>
<v-divider></v-divider>
...
color: #C20052;">Subtotal</p>
    <p style="color:#C20052" class="bigpriceClass">$1,380</p>
</div>
<div class="d-flex">
...
<v-img style="position: relative;border-radius: 10px;" class="mt-6 pt-10 pa-6 rounded-lg" width="100%" cover eager src="https://res.cloudinary.com/payhospi/image/upload/v1684673782/Rectangle_465_sohqlg.png" height="auto">
    <div  class=" ">
