						...
						<v-card flat class="pa-4 cardStyle rounded-lg justify-space-between align-center my-4 d-flex" v-for="n in 2" :key="n">
							<div class="align-center d-flex">
								...
								<div class="text-capitalize px-4">
									...
									<p class="adddressPhone mb-1">Wald steingartenstrasse 13, Vienna, Austria 1020</p>
									<p class="adddressPhone">+43 664 3174106</p>
								</div>
							</div>
							<v-spacer></v-spacer>
							<v-btn size="small" class="smallText" variant="text" color="blue"
						...
						<v-card flat class="cardStyle bg-white rounded-lg mb-4 pa-4 py-6">
							...
							<v-row class="mt-6">
								<v-col class="pb-0" cols="12">
									...
									<v-text-field placeholder="Enter your full name" density="comfortable"> </v-text-field>
								</v-col>
								<v-col cols="12" class="pt-0" md="6">
									<p class="inputLabel">Email Address<span class="mb-2">*</span></p>
									<v-text-field placeholder="Enter your email address" density="comfortable"> </v-text-field
								></v-col>
								<v-col cols="12" md="6">
									<p class="inputLabel">Confirmation email<span class="mb-2">*</span></p>

									<v-text-field placeholder="Enter your confirmation email" density="comfortable"> </v-text-field
								></v-col>
							</v-row>
							...
							<v-text-field placeholder="Enter your Street Name and House Number" density="comfortable"> </v-text-field>
							<v-row class="">
								<v-col cols="12" md="6">
