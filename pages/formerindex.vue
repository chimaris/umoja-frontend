		...
		<v-container class="py-0">
			<div style="max-width: 1200px" class="mx-auto d-flex justify-space-between align-center">
				<v-avatar class="logo" style="width: 123px; height: 80px" rounded="0" flat>
					<v-img eager src="https://res.cloudinary.com/payhospi/image/upload/v1689483300/Frame_3_isko6t.png"> </v-img>
				</v-avatar>

				<v-btn @click="opendialog()" flat size="large" color="green rounded-xl">
					<span style="font-size: 14px"> Join the Waitlist </span>
				</v-btn>
			</div>
		</v-container>
			...
			<v-sheet class="mx-auto" width="100%" style="max-width: 1200px; overflow-x: hidden; border-radius: 15px">
				<v-row class="dialogrow">
					<v-col cols="12" md="7" class="pa-0 d-flex align-center justify-center">
						<div class="py-12">
							<p
								class="mb-4 px-3 subtitles"
								style="color: #000; font-size: 48px; font-weight: 600; line-height: 120%; /* 76.8px */ letter-spacing: -1.44px"
							>
								Join the Umoja Waitlist
							</p>
							<div class="px-8 text-left" style="max-width: 400px">
								<v-form ref="form">
									<p class="inputLabel">Full Name</p>
									<v-text-field :rules="[required]" v-model="name" placeholder="Enter your full name" density="comfortable"> </v-text-field>
									<p class="inputLabel">Email Address</p>
									<v-text-field :rules="[rules.email]" v-model="email" placeholder="Enter your email address" density="comfortable"> </v-text-field>
									<p class="inputLabel">User Category Name</p>
									<v-select
										:rules="[required]"
										:items="['User', 'Vendor']"
										v-model="category"
										placeholder="Select Buyer or Vendor"
					...
					<v-col v-if="!$vuetify.display.smAndDown" cols="12" class="pa-0" md="5">
						<v-carousel continuous :interval="3000" height="568" cycle hide-delimiter-background hide-delimiters hide-controls :show-arrows="false">
							<v-carousel-item
								v-for="n in [
									'https://res.cloudinary.com/payhospi/image/upload/c_fit,w_700/v1689518404/rectangle-1922_a41ixf.png',
									'https://res.cloudinary.com/payhospi/image/upload/c_fit,w_700/v1689486649/rectangle-1922_rfqjbp.png',
								]"
								:key="n"
								height="568"
							>
								<v-card height="568" rounded="0" width="100%" :image="n">
									<div class="pa-8" style="width: 100%; left: 0; bottom: 0; position: absolute">
										<p style="color: #fff; font-size: 14px; max-width: 413px; font-weight: 400; line-height: 140%">
											Join our waitlist today and be the first to experience our social commerce platform.
										</p>
										<p
											class="my-4"
											style="
			...
			<div class="pa-4">
				<v-sheet class="pa-4 mx-auto" width="100%" style="max-width: 504px; border-radius: 20px">
					...
					<div class="text-center">
						<v-avatar size="82"
							><v-img src="https://res.cloudinary.com/payhospi/image/upload/v1689486634/https-lottiefiles-com-91001-success_hwwtuz.png"></v-img
						></v-avatar>
						<p
						...
						<p style="color: var(--carbon-3, #969696); text-align: center; font-size: 16px; font-weight: 400; letter-spacing: -0.351px">
							We’ll let you know when Umoja is ready
						</p>

						<v-btn width="215" color="#EDF0EF" flat rounded="xl" class="mt-4 mb-6"
							><v-icon size="15" color="green" icon="mdi mdi-email-outline" class="mr-2"></v-icon>
							<span style="color: var(--magnetic-green-4, #2c6e63); text-align: center; font-size: 12px; font-weight: 400; line-height: 102.7%">{{
								emailtxt
							}}</span></v-btn
						>
					</div>
	...
	methods: {
		...
		async submitForm() {
			...
			if (validator.valid) {
				this.loading = true;
				axios
					.post("https://umoja-eaac4dc3d4d4.herokuapp.com/api/join_waitlist", {
						name: this.name,
