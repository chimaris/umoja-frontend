<template>
	<div>
		<v-row style="min-height: 100vh">
						...
						<div style="height: calc(100% -150px)">
							<div style="max-width: 385px" class="pt-12 mx-auto">
								...
								<v-text-field
									...
									append-inner-icon="mdi mdi-eye-outline"
								...
								<v-row>
									...
									<v-col cols="6" class="d-flex justify-end py-0 align-center">
										<v-btn to="/vendor/forgot" style="color: #0076ff; text-decoration: none" variant="text" class="px-0 mb-4">
											Forgot Password?
										</v-btn>
									</v-col>
								</v-row>
								...
								<div class="d-flex py-5 justify-space-between align-center">
									<v-divider></v-divider>
									<p class="px-2 w-100 text-grey-lighten-1 social">or continue with</p>
									<v-divider></v-divider>
								</div>
			...
			<v-col v-if="isNotSm == false" :cols="cols[1]" class="px-0 py-0">
...
export default {
	...
	computed: {
		...
		isNotSm() {
			console.log("Screens ", this.$vuetify.display.smAndDown);
			return this.$vuetify.display && this.$vuetify.display.smAndDown;
		},
	},
};
</script>
