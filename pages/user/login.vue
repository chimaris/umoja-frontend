 ...
 <v-form ref="form" @submit.prevent="handleLogin">
	 ...
	 <p v-if="userStore.loginError" style="color: red;">{{ userStore.loginError }}</p>
		 ...
		 <div class="d-flex py-5 justify-space-between align-center"><v-divider></v-divider>
			 <p class="px-2 w-100 text-grey-lighten-1">or continue with</p>
			  <v-divider></v-divider>
			 ...
			 <div class="d-flex justify-space-between py-0 mb-4">
				 ...
				 <v-btn @click="socialMediaLogin('google')" flat style="background-color: #ededed;" class="text-green green-hover" width="30%" icon="mdi mdi-google"></v-btn>
				 <v-btn @click="socialMediaLogin('facebook')" flat style="background-color: #ededed;" class="text-green green-hover" width="30%" icon="mdi mdi-facebook"></v-btn>
			 </div>
