<template>
    ...
    <div style="min-height: 120vh;width: 100%;">
        <v-img
    height="185" style="position: relative;"
    width="100%" cover class="d-flex bg-grey  justify-end align-start"
  ...
  <v-container style="max-width: 1400px;height: 100%; width: 100%;" class="d-flex pt-6 justify-end align-start">
    <v-btn size="large" rounded="xl" flat class="d-flex align-center text-white " style="text-transform:none!important"  color="rgba(0, 0, 0, 0.5)" ><v-icon icon="mdi mdi-pencil-outline" class="mx-2" size="21"></v-icon>
...
font-weight: 600;">
    ...
    <v-card flat class="cardStyle px-0 mt-4 mb-12 py-0">
        <div class="d-flex px-4 pt-6 justify-space-around">
            ...
            <div  :key="n" v-for="n in ['Account Settings', 'Following', 'Manage Password', 'Order History', 'Payment method', 'Address', 'Notification']">
                <v-btn size="large" variant="tonal"  @click="changeTab(n)" rounded="xl" flat :color="selected == n? 'green': 'white'">
                  <v-scale-transition leave-absolute="">
                      ...
                      color: #333;
font-weight: 600;" :style="selected == n? 'color:#2C6E63': ''">
